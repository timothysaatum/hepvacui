...
export const PatientDetailPage: React.FC = () => {
  ...
  const getPaymentStatus = (purchase: VaccinePurchase): string => {
            ...
            {purchasesLoading ? (
              ...
              <div className="space-y-4">
                {purchases.map((purchase) => (
                  <div key={purchase.id} className="border border-gray-200 rounded-xl overflow-hidden hover:border-gray-300 transition-all hover:shadow-sm">
                    <div
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className={`px-2 py-1 text-xs font-semibold rounded-lg border ${getPaymentStatusBadge(getPaymentStatus(purchase))}`}>
                              {getPaymentStatus(purchase).charAt(0).toUpperCase() + getPaymentStatus(purchase).slice(1)}
                            </span>
                          </div>
                        ...
                        <ChevronRight className={`w-5 h-5 text-gray-400 transition-transform ${expandedPurchase === purchase.id ? 'rotate-90' : ''}`} />
                      </div>
                    </div>
                      ...
                      <div className="p-4 bg-white border-t border-gray-200 space-y-4">
                        ...
                        <div className="flex gap-2 pt-2">
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              setAdministerPurchase(purchase);
                            }}
