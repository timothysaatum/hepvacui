...
// import { AllDevicesList } from '../../components/devices/AllDevicesList';
// import { useAuth } from '../../context/useAuth';
// import { AlertTriangle, Smartphone, Info, Shield } from 'lucide-react';

// export const DevicesPage: React.FC = () => {
//   const { user } = useAuth();
//   const [activeTab, setActiveTab] = useState<'pending' | 'all' | 'myDevices'>('pending');
...
//               className={`flex items-center gap-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === 'all'
//                   ? 'border-black text-black'
//                   : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
//                 }`}
//             >
